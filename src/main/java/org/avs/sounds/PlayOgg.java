...
public class PlayOgg {
	 ...
	 */
	public PlayOgg(String ref) throws IOException {
		this(new FileInputStream(ref));
	}

	public PlayOgg(File f) throws IOException {
	 ...
	 */
	public PlayOgg(InputStream in) throws IOException {
		init(in);
	}
	...
	private class InternalException extends Exception {
		private static final long serialVersionUID = -3997044895050569777L;
